<?php
  ...
  $comando = ("SELECT * FROM arquivo WHERE formato = 'excell'");
      ...
      <article class="container">
        ...
        <div class="">
          <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="arquivoexcell.php"><i class="fa fa-file-excel-o" aria-hidden="true"></i> EXCELL</a></li>
          </ul><br>
        </div>
        <div class="row">
