<?php
$comando = "SELECT COUNT(Idaspirante) qtd FROM aspirante where ativo='sim'";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="index.php"><i class="fa fa-user" aria-hidden="true"></i> Membros <span class="sr-only">(current)</span></a></li>
        <li class="active"><a href="aspirantes.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Aspirantes <span class="sr-only">(current)</span><span class="badge"><?php print $quantidade['qtd'];?></span></a></li>
        <li class="dropdown">
