<?php
  ...
  $comando = ("SELECT * FROM depoimento WHERE moderacao = 'sim'");
    ...
    <section>
      ...
      <article class="container">
        ...
        <ul class="nav nav-tabs">
          <li role="presentation" class="active"><a href="depoimentoa.php"><i class="fa fa-gavel" aria-hidden="true"></i> Depoimentos Aprovados</a></li>
          <li role="presentation"><a href="depoimentor.php"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Depoimentos a serem Aprovados</a></li>
        </ul><br>
        <div class="row">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <td class="col-md-1"><a class="btn btn-info btn-sm" href="atualizadpr.php?id=<?php print $depoimento['iddep']; ?>"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Reprovar</a></td>
