<?php
  ...
  $comando = ("SELECT * FROM membro WHERE ativo = 'sim'");
      ...
      <article class="container">
        ...
        <div class="">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="index.php"><i class="fa fa-check" aria-hidden="true"></i> Membros Ativos</a></li>
            <li role="presentation"><a href="membrosinativos.php"><i class="fa fa-exclamation" aria-hidden="true"></i> Membros Inativos</a></li>
          </ul><br>
        </div>
        <div class="row">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <td class="col-md-1"><?php
                          ...
                          ?></th>
              <td class="col-md-4"><a class="btn btn-danger btn-sm" href="atualizami.php?id=<?php print $membro['Idmembro']; ?>"><i class="fa fa-exclamation" aria-hidden="true"></i> Inativar</a> <a class="btn btn-warning btn-sm" href="editarmembro.php?id=<?php print $membro['Idmembro']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</a> <?php if($_SESSION['nivel'] == 'Administrador'){ ?> <a onclick="excluir(<?php print $membro['Idmembro']; ?>)" class="btn btn-danger btn-sm" id="<?php print $membro['Idmembro']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Excluir</a><?php } ?></th>
            </tbody>
            <?php   }  ?>
          </table>
        </div>
