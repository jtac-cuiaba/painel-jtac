<?php
  ...
  $comando = ("SELECT * FROM arquivo WHERE formato = 'pdf'");
      ...
      <article class="container">
        ...
        <div class="">
          <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="arquivopdf.php"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a></li>
