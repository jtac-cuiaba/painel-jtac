<?php
  ...
  $comando = ("SELECT * FROM aspirante WHERE ativo = 'sim'");
      ...
      <article class="container">
        ...
        <div class="">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="aspirantes.php"><i class="fa fa-check" aria-hidden="true"></i> Aspirantes Ativos</a></li>
            <li role="presentation"><a href="aspiranteinativos.php"><i class="fa fa-exclamation" aria-hidden="true"></i> Aspirantes Inativos</a></li>
          </ul><br>
        </div>
        <div class="row">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <td class="col-md-1"><?php
                          ...
                          ?></th>
              <td class="col-md-4"><a class="btn btn-success btn-sm" href="promover.php?id=<?php print $aspirante['Idaspirante']; ?>"><i class="fa fa-external-link-square" aria-hidden="true"></i> Promoção</a> <a class="btn btn-danger btn-sm" href="atualizaai.php?id=<?php print $aspirante['Idaspirante']; ?>"><i class="fa fa-exclamation" aria-hidden="true"></i> Inativar</a> <a class="btn btn-warning btn-sm" href="editaraspira.php?id=<?php print $aspirante['Idaspirante']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</a> <?php if($_SESSION['nivel'] == 'Administrador'){ ?> <a onclick="return confirm('Tem Certeza que deseja Excluir esse Aspirante?');" class="btn btn-danger btn-sm" href="excluiraspira.php?id=<?php print $aspirante['Idaspirante']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Excluir</a><?php } ?></th>
            </tbody>
            <?php   }  ?>
          </table>
        </div>
